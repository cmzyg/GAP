 ...
 */
class GmapiServers extends \model\gmapi\GmapiServers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'model\\gmapi\\GmapiServers' . "\0" . 'id', '' . "\0" . 'model\\gmapi\\GmapiServers' . "\0" . 'serverName');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GmapiServers $proxy) {
