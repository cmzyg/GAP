 ...
 */
class GmapiExtraConfiguration extends \model\gmapi\GmapiExtraConfiguration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'model\\gmapi\\GmapiExtraConfiguration' . "\0" . 'id', '' . "\0" . 'model\\gmapi\\GmapiExtraConfiguration' . "\0" . 'configurationName', '' . "\0" . 'model\\gmapi\\GmapiExtraConfiguration' . "\0" . 'configuration', '' . "\0" . 'model\\gmapi\\GmapiExtraConfiguration' . "\0" . 'license');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GmapiExtraConfiguration $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setLicense(\model\gmapi\GmapiLicensee $license)
    {
