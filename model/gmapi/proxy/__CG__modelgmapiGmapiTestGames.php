 ...
 */
class GmapiTestGames extends \model\gmapi\GmapiTestGames implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'model\\gmapi\\GmapiTestGames' . "\0" . 'id', '' . "\0" . 'model\\gmapi\\GmapiTestGames' . "\0" . 'componentName', '' . "\0" . 'model\\gmapi\\GmapiTestGames' . "\0" . 'license', '' . "\0" . 'model\\gmapi\\GmapiTestGames' . "\0" . 'skin');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GmapiTestGames $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setLicense(\model\gmapi\GmapiLicensee $license = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setSkin(\model\gmapi\GmapiGames $skin = NULL)
    {
